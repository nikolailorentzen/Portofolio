...
const App = () => {
  ...
  return (
    <div className="relative w-screen h-screen bg-transparent overflow-scroll-y overflow-x-hidden h-full">
        <div className="flex flex-col lg:flex-row lg:mx-auto min-h-screen max-w-screen-xl font-sans px-14 lg:px-24 lg:py-0 items-center">

          {/* Left Section */}
          <div className="lg:sticky lg:top-0 flex flex-col justify-start lg:justify-between w-1/2 lg:min-h-screen lg:h-screen py-24 self-start">
           ...
           {/* Right Section */}
          <main id="about" className="flex flex-col min-w-10 lg:w-1/2 lg:py-24 lg:mb-0 mb-10">
            <About/>
            <Experience/>
            <Projects/>
          </main>
